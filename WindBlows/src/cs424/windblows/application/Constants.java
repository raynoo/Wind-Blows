...
public class Constants {
	...
	public static int mapHeight = 325;
	
	//Map buttons
	public static int zoomInButtonX = 602;
	public static int zoomInButtonY = 273;
	public static int panLeftButtonX = 584;
	public static int panLeftButtonY = 281;
	public static int panRightButtonX = 620;
	public static int panRightButtonY = 281;
	...
	public static int keywordPanelWidth = 215;
	public static int keywordPanelHeight = 240;
	
	//Word Cloud Panel
	public static int wcX = 895;
	public static int wcY = 0;
	public static int wcWidth = 465;
	public static int wcHeight = 130;
	
	//Weather Panel outline
	public static int weatherGraphicX = 680;
